...
function Profile() {
  ...
  return (
    ...
    >
      <div className="fixed top-24 right-10 w-96 h-96 bg-violet-300 rounded-full mix-blend-multiply filter blur-3xl opacity-12 animate-blob"></div>
      <div className="fixed bottom-20 left-10 w-96 h-96 bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-12 animate-blob animation-delay-2000"></div>
                ...
                <form onSubmit={handleUpdate} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full rounded-lg border border-violet-100 bg-white px-4 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-violet-100 transition"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 p-4 bg-gradient-to-br from-violet-50 to-purple-50 rounded-lg border border-violet-100">
                    <div className="text-center">
                      <p className="text-2xl md:text-3xl font-extrabold text-violet-600">12</p>
                      <p className="text-xs font-semibold text-gray-600 mt-1">Events Joined</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl md:text-3xl font-extrabold text-purple-600">5</p>
                      <p className="text-xs font-semibold text-gray-600 mt-1">Events Created</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl md:text-3xl font-extrabold text-indigo-600">8</p>
                      <p className="text-xs font-semibold text-gray-600 mt-1">Reviews Given</p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-4 pt-6 border-t border-violet-100">
                    <button
                      type="submit"
                      disabled={loading}
                      className={`flex-1 rounded-lg py-3 text-lg font-semibold transition transform hover:scale-102 shadow-md ${
                        loading ? "bg-gray-400 text-white cursor-not-allowed" : "bg-gradient-to-r from-violet-600 to-purple-600 text-white"
                      }`}
                    >
                    ...
                    <button
                      ...
                      className="flex-1 md:flex-none md:px-8 rounded-lg py-3 border border-red-500 bg-white text-red-600 font-semibold hover:bg-red-50 transition"
                    >
                      Logout
                    </button>
                  </div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg flex items-center justify-center bg-purple-50">
                <svg className="w-5 h-5 text-purple-600" viewBox="0 0 24 24" fill="none" aria-hidden>
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg flex items-center justify-center bg-indigo-50">
                <svg className="w-5 h-5 text-indigo-600" viewBox="0 0 24 24" fill="none" aria-hidden>
                  <path d="M4 12h16M12 5v14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
              </div>
              <div>
